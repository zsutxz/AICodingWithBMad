...
namespace Gomoku.Core
{
    ...
    {
        // Game State Events
        public static event System.Action<Gomoku.Systems.GameStateEnum> OnGameStateChanged;
        ...
        public static void GameStateChanged(Gomoku.Systems.GameStateEnum state)
        {
